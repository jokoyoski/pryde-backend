...
namespace Pryde.Persistence.Migrations
{
    ...
    [Migration("20260903081428_AddBookingChats")]
    partial class AddBookingChats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.BookingChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BookingChats");
                });

            modelBuilder.Entity("Pryde.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.KycVerificationAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AttemptGroupReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("CallbackPayloadHash")
                        .HasMaxLength(64)
                    ...
                    b.Property<string>("ExternalUserReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<DateTime?>("ProviderEventTimestamp")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("SmileActionSucceeded")
                        .HasColumnType("boolean");

                    b.Property<bool>("SmileIdentitySucceeded")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("ProviderName", "CorrelationReference")
                        .IsUnique();

                    b.HasIndex("ProviderName", "ProviderReference")
                        .IsUnique()
                        .HasFilter("\"ProviderReference\" IS NOT NULL");

                    b.ToTable("KycVerificationAttempts");
                });
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.PaystackWalletFundingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PaystackTransactionId")
                        .IsUnique()
                    ...
                    b.ToTable("PaystackWalletFundingRequests");
                });
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.RecurringTrip", b =>
                {
                    ...
                    b.Property<int>("BookingWindowMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.SavedRecurringTrip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.Trip", b =>
                {
                    ...
                    b.HasIndex("RecurringTripId", "DepartureTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.TripRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BookingId", "RaterId")
                        .IsUnique();

                    b.ToTable("TripRatings", t =>
                        {
                            t.HasCheckConstraint("CK_TripRatings_Value", "\"Value\" >= 1 AND \"Value\" <= 5");
                        });
                });
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.BookingChat", b =>
                {
                    b.HasOne("Pryde.Domain.Entities.TripBooking", "Booking")
                        .WithOne("Chat")
                        .HasForeignKey("Pryde.Domain.Entities.BookingChat", "BookingId")
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("Pryde.Domain.Entities.BookingChat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pryde.Domain.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.KycVerificationAttempt", b =>
                {
                    b.HasOne("Pryde.Domain.Entities.KycVerification", "KycVerification")
                        .WithMany("Attempts")
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.TripRating", b =>
                {
                    ...
                    b.HasOne("Pryde.Domain.Entities.User", "RatedUser")
                        .WithMany()
                        .HasForeignKey("RatedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Pryde.Domain.Entities.User", "Rater")
                        .WithMany()
            ...
            modelBuilder.Entity("Pryde.Domain.Entities.RecurringTrip", b =>
                {
                    b.Navigation("SavedByPassengers");
